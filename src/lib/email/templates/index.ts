...
export const EMAIL_CATALOG: CatalogEntry[] = [
  ...
  { key: "mentioned", category: "Community", label: "Someone mentioned you", recipient: "Mentioned member", trigger: "@handle in a post or reply", humour: "Subtle", gifKey: "newComment", render: () => community.mentioned({ name: NAME, author: "Meera Iyer", excerpt: "@shubham this is the one I was telling you about — worth a look.", href: `${SITE}/community/p/2026-1` }) },
  ...
  { key: "membershipEnded", category: "Membership", label: "Membership ended", recipient: "Ex-member", trigger: "Razorpay cancelled / completed / paused", humour: "Subtle", gifKey: "membershipEnded", render: () => membership.membershipEnded({ name: NAME, planName: "Annual" }) },
