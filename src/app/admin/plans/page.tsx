  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        description="Set the price, then click Create in Razorpay — it creates the plan on Razorpay (same account as your other payments) and activates it. No Razorpay dashboard needed. Amounts are in paise (₹149 = 14900)."
      />
