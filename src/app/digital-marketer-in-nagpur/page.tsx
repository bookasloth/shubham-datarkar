...
import { digitalMarketerNagpur as c } from "@/lib/data/landing/digital-marketer-nagpur";
...
export const metadata = buildMetadata({
  title: c.metaTitle, // "Digital Marketer in Nagpur" — brand appended by root template
  description: c.metaDescription,
  path: c.path,
});

// ProfessionalService + Person JSON-LD for local + entity relevance (AEO/GEO).
// This is the local-business entity the "digital marketer in Nagpur" query
// resolves against — the site otherwise emits only a Person node.
const localBusinessSchema = {
  "@context": "https://schema.org",
  "@type": "ProfessionalService",
  "@id": `${site.url}${c.path}#business`,
  name: "Digital Marketer in Nagpur — Shubham Datarkar",
  description: c.metaDescription,
  url: `${site.url}${c.path}`,
  areaServed: [
    ...
    <>
      <JsonLd
        data={[
          ...
          breadcrumbSchema([
            { name: "Home", path: "/" },
            { name: "Digital Marketer in Nagpur", path: c.path },
          ]),
          faqSchema(c.faqs),
        ]}
      />
