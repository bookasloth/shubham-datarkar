import {
  ...
  Quote, Users, Mail, CreditCard, Share2, Link2, Plug, Image as ImageIcon, Gamepad2, Search,
  Library, Tags, MessageSquarePlus, UserRound, Bell, BarChart3, type LucideIcon,
} from "lucide-react";
