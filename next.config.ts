...
const nextConfig: NextConfig = {
  ...
  async headers() {
    ...
    const directives = [
      ...
      "img-src 'self' data: blob: https://*.supabase.co https://company-assets.bookasloth.in https://website-assets.shubhamdatarkar.com https://image.tmdb.org https://www.openstreetmap.org https://www.facebook.com https://www.googletagmanager.com",
      "font-src 'self' data:",
      "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://*.razorpay.com https://*.vercel-insights.com https://va.vercel-scripts.com https://www.facebook.com https://connect.facebook.net https://www.googletagmanager.com",
