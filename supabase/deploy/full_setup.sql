...
-- >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
-- FILE: supabase/migrations/20260616000002_kit_integration.sql
-- >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
-- Kit (ConvertKit) integration: encrypted API key/form id + status metadata.
-- Secret 'kit_email' in Vault, reached only via service-role RPCs.
-- Target: your OWN Supabase project. Run manually.
...
-- >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
-- FILE: supabase/migrations/20260616000003_contacts_email.sql
-- >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
...
create policy "email_integration_authenticated_read"
  on public.email_integration for select to authenticated using (true);
