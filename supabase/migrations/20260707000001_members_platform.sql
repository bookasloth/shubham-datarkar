...
insert into public.membership_plans (key, name, description, amount, interval, sort) values
  ('premium-monthly','Premium Monthly','Full access to everything, billed monthly', 14900, 'monthly', 1),
  ('premium-yearly','Premium Yearly','Full access to everything, billed yearly', 149900, 'yearly', 2)
on conflict (key) do nothing;
